...
* 1.给图形添加标注:
   ...
   * 使用LATEX格式控制符
   ...
   title('y=e^{ext}') %<div markdown="0"> <a href="https://www.codecogs.com/eqnedit.php?latex=y=e^{axt}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?y=e^{axt}" title="y=e^{axt}" /></a></div>
